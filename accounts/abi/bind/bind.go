...
// Package bind generates NetworkChain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-networkchain Wiki page:
// https://github.com/networkchain/go-networkchain/wiki/Native-DApps:-Go-bindings-to-NetworkChain-contracts
package bind
