...
//
// Detailed usage document and tutorial available on the networkchain Wiki page:
// https://github.com/networkchain/networkchain/wiki/Native-DApps:-Go-bindings-to-NetworkChain-contracts
package bind
