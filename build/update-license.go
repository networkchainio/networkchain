...
var (
	...
	authorsFileHeader = "# This is the official list of networkchain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The networkchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The networkchain library"
	}
	return "the networkchain library"
}
