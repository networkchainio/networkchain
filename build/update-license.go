...
var (
	...
	authorsFileHeader = "# This is the official list of go-networkchain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-networkchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-networkchain"
	}
	if startOfSentence {
		return "The go-networkchain library"
	}
	return "the go-networkchain library"
}
