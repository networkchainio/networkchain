...
type wizard struct {
	...
	services map[string][]string   // NetworkChain services known to be running on servers
...
// converts it to an NetworkChain address. If an empty line is entered, the default
// value is returned.
