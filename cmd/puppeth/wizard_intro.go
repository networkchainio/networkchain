...
// setting up a new or managing an existing NetworkChain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your NetworkChain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new NetworkChain network down to  |")
	...
	log.Info("Administering NetworkChain network", "name", w.network)
