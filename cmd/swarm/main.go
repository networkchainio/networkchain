...
import (
	...
	"github.com/networkchain/go-networkchain/contracts/ens"
	...
	bzzapi "github.com/networkchain/go-networkchain/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:  "swap-api",
		Usage: "URL of the NetworkChain API provider to use to settle SWAP payments",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		Name:  "ens-api",
		Usage: "URL of the NetworkChain API provider to use for ENS record lookups",
		Value: node.DefaultIPCEndpoint("netk"),
	}
...
// This init function sets defaults so cmd/swarm can run alongside netk.
func init() {
...
var app = utils.NewApp(gitCommit, "NetworkChain Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-networkchain Authors"
