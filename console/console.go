...
import (
	...
	"github.com/networkchain/go-networkchain/internal/jsre"
	"github.com/networkchain/go-networkchain/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute NetworkChain requests through
...
// Welcome show summary of current Netk instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Netk metadata
	fmt.Fprintf(c.printer, "Welcome to the Netk JavaScript console!\n\n")
	c.jsre.Run(`
