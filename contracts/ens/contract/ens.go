...
// DeployENS deploys a new NetworkChain contract, binding an instance of ENS to it.
...
// ENS is an auto generated Go binding around an NetworkChain contract.
type ENS struct {
	ENSCaller     // Read-only binding to the contract
	ENSTransactor // Write-only binding to the contract
}

// ENSCaller is an auto generated read-only Go binding around an NetworkChain contract.
type ENSCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSTransactor is an auto generated write-only Go binding around an NetworkChain contract.
type ENSTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSSession is an auto generated Go binding around an NetworkChain contract,
...
// ENSCallerSession is an auto generated read-only Go binding around an NetworkChain contract,
...
// ENSTransactorSession is an auto generated write-only Go binding around an NetworkChain contract,
...
// ENSRaw is an auto generated low-level Go binding around an NetworkChain contract.
type ENSRaw struct {
	Contract *ENS // Generic contract binding to access the raw methods on
}

// ENSCallerRaw is an auto generated low-level read-only Go binding around an NetworkChain contract.
type ENSCallerRaw struct {
	Contract *ENSCaller // Generic read-only contract binding to access the raw methods on
}

// ENSTransactorRaw is an auto generated low-level write-only Go binding around an NetworkChain contract.
...
// DeployFIFSRegistrar deploys a new NetworkChain contract, binding an instance of FIFSRegistrar to it.
...
// FIFSRegistrar is an auto generated Go binding around an NetworkChain contract.
...
// FIFSRegistrarCaller is an auto generated read-only Go binding around an NetworkChain contract.
type FIFSRegistrarCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarTransactor is an auto generated write-only Go binding around an NetworkChain contract.
type FIFSRegistrarTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarSession is an auto generated Go binding around an NetworkChain contract,
// with pre-set call and transact options.
...
// FIFSRegistrarCallerSession is an auto generated read-only Go binding around an NetworkChain contract,
// with pre-set call options.
...
// FIFSRegistrarTransactorSession is an auto generated write-only Go binding around an NetworkChain contract,
// with pre-set transact options.
...
// FIFSRegistrarRaw is an auto generated low-level Go binding around an NetworkChain contract.
type FIFSRegistrarRaw struct {
	Contract *FIFSRegistrar // Generic contract binding to access the raw methods on
}

// FIFSRegistrarCallerRaw is an auto generated low-level read-only Go binding around an NetworkChain contract.
...
// FIFSRegistrarTransactorRaw is an auto generated low-level write-only Go binding around an NetworkChain contract.
...
// DeployPublicResolver deploys a new NetworkChain contract, binding an instance of PublicResolver to it.
...
// PublicResolver is an auto generated Go binding around an NetworkChain contract.
type PublicResolver struct {
	PublicResolverCaller     // Read-only binding to the contract
	PublicResolverTransactor // Write-only binding to the contract
}

// PublicResolverCaller is an auto generated read-only Go binding around an NetworkChain contract.
type PublicResolverCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverTransactor is an auto generated write-only Go binding around an NetworkChain contract.
type PublicResolverTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverSession is an auto generated Go binding around an NetworkChain contract,
// with pre-set call and transact options.
...
// PublicResolverCallerSession is an auto generated read-only Go binding around an NetworkChain contract,
// with pre-set call options.
...
// PublicResolverTransactorSession is an auto generated write-only Go binding around an NetworkChain contract,
// with pre-set transact options.
...
// PublicResolverRaw is an auto generated low-level Go binding around an NetworkChain contract.
type PublicResolverRaw struct {
	Contract *PublicResolver // Generic contract binding to access the raw methods on
}

// PublicResolverCallerRaw is an auto generated low-level read-only Go binding around an NetworkChain contract.
...
// PublicResolverTransactorRaw is an auto generated low-level write-only Go binding around an NetworkChain contract.
...
// DeployResolver deploys a new NetworkChain contract, binding an instance of Resolver to it.
...
// Resolver is an auto generated Go binding around an NetworkChain contract.
type Resolver struct {
	ResolverCaller     // Read-only binding to the contract
	ResolverTransactor // Write-only binding to the contract
}

// ResolverCaller is an auto generated read-only Go binding around an NetworkChain contract.
type ResolverCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ResolverTransactor is an auto generated write-only Go binding around an NetworkChain contract.
type ResolverTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ResolverSession is an auto generated Go binding around an NetworkChain contract,
// with pre-set call and transact options.
...
// ResolverCallerSession is an auto generated read-only Go binding around an NetworkChain contract,
// with pre-set call options.
...
// ResolverTransactorSession is an auto generated write-only Go binding around an NetworkChain contract,
// with pre-set transact options.
...
// ResolverRaw is an auto generated low-level Go binding around an NetworkChain contract.
type ResolverRaw struct {
	Contract *Resolver // Generic contract binding to access the raw methods on
}

// ResolverCallerRaw is an auto generated low-level read-only Go binding around an NetworkChain contract.
type ResolverCallerRaw struct {
	Contract *ResolverCaller // Generic read-only contract binding to access the raw methods on
}

// ResolverTransactorRaw is an auto generated low-level write-only Go binding around an NetworkChain contract.
