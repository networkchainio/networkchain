...
// stateObject represents an NetworkChain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of networkchain address of the account
	data     Account
	db       *StateDB
...
// Account is the NetworkChain consensus representation of accounts.
