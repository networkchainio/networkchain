...
// Package types contains data types related to NetworkChain consensus.
package types
...
// Header represents a block header in the NetworkChain blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) tonetker.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the NetworkChain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the NetworkChain
...
// EncodeRLP serializes b into the NetworkChain RLP block format.
