...
public class AndroidTest extends InstrumentationTestCase {
	...
	// signatures too. Regression test for networkchain issue #14599.
...
func TestAndroid(t *testing.T) {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.networkchain", "github.com/networkchain/networkchain/mobile")
