...
// Contains a wrapper for the NetworkChain client.
...
func (ec *NetworkChainClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *NetworkChainClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *NetworkChainClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *NetworkChainClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *NetworkChainClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *NetworkChainClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *NetworkChainClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *NetworkChainClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *NetworkChainClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *NetworkChainClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *NetworkChainClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *NetworkChainClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *NetworkChainClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
...
func (ec *NetworkChainClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
