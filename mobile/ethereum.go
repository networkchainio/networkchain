...
// Contains all the wrappers from the go-networkchain root package.
...
// the NetworkChain network.
type SyncProgress struct {
	progress networkchain.SyncProgress
}
...
type FilterQuery struct {
	query networkchain.FilterQuery
}
