...
import (
	...
	"github.com/networkchain/go-networkchain/trie"
)

const defaultTraceTimeout = 5 * time.Second

// PublicNetworkChainAPI provides an API to access NetworkChain full node-related
// information.
type PublicNetworkChainAPI struct {
	e *NetworkChain
}

// NewPublicNetworkChainAPI creates a new Etheruem protocol API for full nodes.
func NewPublicNetworkChainAPI(e *NetworkChain) *PublicNetworkChainAPI {
	return &PublicNetworkChainAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicNetworkChainAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicNetworkChainAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicNetworkChainAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *NetworkChain) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *NetworkChain) *PrivateMinerAPI {
...
// admin methods of the NetworkChain service.
func NewPrivateAdminAPI(eth *NetworkChain) *PrivateAdminAPI {
...
// related public debug methods of the NetworkChain service.
func NewPublicDebugAPI(eth *NetworkChain) *PublicDebugAPI {
...
// private debug methods of the NetworkChain service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *NetworkChain) *PrivateDebugAPI {
