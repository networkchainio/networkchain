...
// ContractBackend implements bind.ContractBackend with direct calls to NetworkChain
// internals to support operating on contracts within subprotocols like eth and
// swarm.
//
// Internally this backend uses the already exposed API endpoints of the NetworkChain
...
func NewContractBackend(apiBackend ethapi.Backend) *ContractBackend {
	return &ContractBackend{
		eapi:  ethapi.NewPublicNetworkChainAPI(apiBackend),
...
// ContractCall implements bind.ContractCaller executing an NetworkChain contract
...
func toCallArgs(msg networkchain.CallMsg) ethapi.CallArgs {
