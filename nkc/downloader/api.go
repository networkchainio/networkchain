...
// Syncing provides information when this nodes starts synchronising with the NetworkChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  networkchain.SyncProgress `json:"status"`
}
