...
import (
	...
	"github.com/networkchain/go-networkchain/crypto/ecies"
	"github.com/networkchain/go-networkchain/event/filter"
...
// Whisper represents a dark communication interface through the NetworkChain
...
// New creates a Whisper client ready to communicate through the NetworkChain P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
